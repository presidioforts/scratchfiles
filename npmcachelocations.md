...
task configureNpmCache {
    doLast {
        ...
        // Print the locations of the .npmrc files being used
        exec {
            commandLine 'npm', 'config', 'get', 'userconfig'
        }
        exec {
            commandLine 'npm', 'config', 'get', 'globalconfig'
        }
        exec {
            commandLine 'npm', 'config', 'get', 'projectconfig'
        }
    }
}
