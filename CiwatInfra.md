...
Yes, adding an Infrastructure section to your API documentation is an excellent idea. This section can provide valuable information about the environments where the API is hosted, dependencies like Kafka topics, and other infrastructure-related details. You can capture this information in a new table or a dedicated section.

Here's how you might incorporate this into your documentation:
